...
function minimizeTargetReadiness(value) {
  ...
  return {
    ...
    hazards: strings(r.hazards, 8).map(v => text(v, 160)),
    guidance: strings(r.guidance, 6).map(v => text(v, 420))
  };
}
